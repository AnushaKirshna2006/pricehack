...
export default function ProductCard({ product, currency }) {
  ...
  return (
    <a 
      ...
      className={`group flex flex-row items-center p-3 h-32 w-full bg-[#F7F7F7]/[0.02] backdrop-blur-xl rounded-2xl border border-[#F7F7F7]/5 hover:border-[#F7F7F7]/20 hover:bg-[#F7F7F7]/[0.04] transition-all duration-300 relative cursor-pointer ${style.glow}`}
    >
      
      {/* Product Image Thumbnail */}
      <div className="h-full w-28 flex-shrink-0 bg-white rounded-xl flex items-center justify-center p-2 mr-5 shadow-inner">
        {image_url ? (
          <img 
      ...
      {/* Main Content Area */}
      <div className="flex flex-1 items-center h-full gap-6">
        
        {/* Title & Price Column */}
        <div className="flex flex-col flex-1 min-w-0 pr-6 border-r border-[#F7F7F7]/10 h-full justify-center">
        ...
        {/* Condition Column */}
        <div className="flex flex-col w-28 flex-shrink-0 justify-center pl-2">
          <span className="text-[10px] text-gray-200 font-bold uppercase tracking-widest mb-1">Condition</span>
        ...
        {/* Rating Column */}
        <div className="flex flex-col items-end justify-center w-24 flex-shrink-0 pr-4">
          ...
          <span className="text-[11px] text-gray-200 font-semibold">({reviews || "150"} reviews)</span>
        </div>
        
        {/* Link Arrow */}
        <div className="w-8 flex justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity -translate-x-2 group-hover:translate-x-0 duration-300">
