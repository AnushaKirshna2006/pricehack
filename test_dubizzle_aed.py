...
async def test():
    ...
    async with httpx.AsyncClient() as client:
        params = {"engine": "google", "q": "site:dubizzle.com laptop \"AED\"", "api_key": api_key, "gl": "ae"}
        ...
        for item in dub:
            ...
            print(f"PRICE: {item.get('rich_snippet', {}).get('top', {}).get('detected_extensions', {}).get('price')}\n")
